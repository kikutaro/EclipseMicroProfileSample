...
This will create an executable jar file **microprofilesample-thorntail.jar** within the _target_ maven folder. This can be started by executing the following command
